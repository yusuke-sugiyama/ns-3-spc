 ...
 */
#ifndef SPC_RANDOM_STREAM_H
#define SPC_RANDOM_STREAM_H
...
/**
 * A spc wrapper around RngStream to make testing
 * of the code easier.
 */
class SpcRandomStream
{
public:
  virtual ~SpcRandomStream ();
  /**
...
class SpcRealRandomStream : public SpcRandomStream
{
public:
  SpcRealRandomStream ();
