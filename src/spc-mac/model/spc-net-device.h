 ...
 */
#ifndef SPC_NET_DEVICE_H
#define SPC_NET_DEVICE_H
 ...
 * 
 * \brief spc net device for spc things and testing
 */
class SpcNetDevice : public NetDevice
{
public:
  /**
  ...
  SpcNetDevice ();
  void SetPhy (Ptr<SpcPhy> phy);
  void SetMac (Ptr<SpcMac> mac);
  Ptr<SpcPhy> GetPhy ();
  Ptr<SpcMac> GetMac ();
...
private:
  ...
  Ptr<SpcMac> m_mac; //!< Mac this netDevice is associated to
  Ptr<SpcPhy> m_phy; //!< Mac this netDevice is associated to
  uint16_t m_mtu;   //!< MTU
